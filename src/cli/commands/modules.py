...
from ..exceptions import InvalidModuleNameException, ModuleExistsException
...
def generate_module(module_name: str, target_dir: Path) -> Path:
...
def new_module(
    ...
    try:
        module_dir = generate_module(module_name, target_dir)
    except (InvalidModuleNameException, ModuleExistsException) as error:
